...
angular.module('geometiersmodulejsApp')
  .directive('leafletGeometiers', ["Webservice", "tools", "Filtre", "$routeParams", function (Webservice,tools,Filtre,$routeParams) {
    	  return {
    ...
    return {
      ...
      link: function postLink(scope, element, attrs) {
		...
		var defaultFiltres = function () {
			...
			return {
				//stats    :  $filter('formatfilter')('nbrentr'),
