...
a.put("views/geometiersmodulejs.share.html",'<div id="stats-resultat" ng-show="statistique.resultat._valeur != null"> <div id="titre-resultat" class="mdl-cell mdl-cell--12-col"> <h3 ng-bind="statistique.type"></h3> <h1 ng-bind="statistique.nom"></h1> </div> <div id="nbr-resultat" class="mdl-cell mdl-cell--12-col"> <span ng-show="statistique.resultat._valeur != null" class="chiffre" ng-bind="statistique.resultat._valeur"></span> <span ng-show="statistique.resultat._valeur != null" class="percent" ng-bind="statistique.resultat._type"></span> <span ng-show="statistique.resultat._valeur == null" class="chiffre error">Pas d\'établissement</span> </div> <div id="type-resultat" class="mdl-cell mdl-cell--12-col"> <span class="stats">{{statistique.resultat._nom}}</span> <p class="info" ng-bind="statistique.resultat._info"></p> </div> <ul class="chiffrescles mdl-list"> <li class="mdl-list__item" ng-repeat="chiffre in statistique.chiffres"> <span class="mdl-list__item-primary-content" ng-bind="chiffre._nom"></span> <span class="mdl-list__item-secondary-content" ng-bind="chiffre._valeur"></span> </li> </ul> </div>')}]);